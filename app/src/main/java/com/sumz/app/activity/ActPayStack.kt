...
import com.sumz.app.databinding.ActPayStackBinding
import com.sumz.app.utils.CreditCardTextFormatter
...
class ActPayStack : AppCompatActivity() {
    ...
    private fun handleClicks() {
        binding.btnPay.setOnClickListener {
            if (com.sumz.app.utils.Common.isCheckNetwork(this@ActPayStack)) {
